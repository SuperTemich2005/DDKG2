...
func _ready():
	...
	Anims = [ # массив, в котором 1 слово это перс, а 2 - его анимка
		"",
		"character_lentoln SHOWтольевна: Все готовы?",
		"*стук*",
		"START trial Судебное заседание по делу Марии Фильмоновой объявляется открытым!",
		"Стороны готовы?",
		...
		"(Это желание не покидало меня с тех пор, как я услышал её имя)",
		"(Что со мной не так???)",
		"character_sonya SHOW : Жертва - Ира Жарова. Y POS pro",
		"Подозревается Мария Фильмонова.",
		"Обвинение - нанесение телесных повреждений",
		"Мотив - ревность",
		...
		"character_sonya SHOW : Улики: Y POS pro",
		"~~~ Медкнижка Жаровой добавлена в записи суда.",
		"~~~ Видеозапись добавлена в записи суда.",
		...
		"Или у тебя еще остались сомнения?",
		"character_egorich SHOW А что, если это не видео? POS hld",
		"character_lentoln SHOW тольевна: Ч-Что? POS jud",
		"Это ВИДЕОЗАПИСЬ",
		"И это ФАКТ",
		"Артём, ты можешь включить эту запись?",
		"character_temich SHOW : Да, наверняка. POS def",
		"character_egorich SHOW Вау, это действительно видеозапись POS hld",
		"character_lentoln SHOW тольевна: На карточке написано 'Видеозапись' POS jud",
		"В записях суда эта карточка числится как видеозапись",
		"Я сама просмотрела эту запись и на моих глазах Аполлонов записал её",
		"Но у Ищенко Егора все равно сомнения..............",
		"character_temich SHOW : (Это ироничное молчание было крайне ироничным.) B POS def",
		"character_lentoln SHOW тольевна: Что же, попрошу первого свидетеля к трибуне. W POS jud",
		"character_sonya SHOW : ... POS pro",
		"Ищейка. Y",
		"character_temich SHOW : БАНКОВСКАЯ ЯЧЕЙКА!!! W POS def",
		"АААААА, ШУУУУУТКАААААА-ЮЮЮЮЮМООООООР ПОДОСПЕЕЕЕЕЕЕЛ",
		"character_lentoln SHOW тольевна: ? POS jud",
		"character_egorich SHOW ? POS hld",
		"character_sonya SHOW : ? POS pro",
		"character_temich SHOW : ... Это было как-то неуместно, да? POS def",
		"character_lentoln SHOW тольевна: ............ POS jud",
		"character_temich SHOW : (Это молчание давит на меня... Нужно следить за юмором своим.) B POS def",
		"Эмм, ладно, давайте этого вашего следователя... W",
		"character_sonya SHOW : ... POS pro",
		"character_egorich SHOW Кстати, Тьоха... Ты помнишь, что вчера Лентольна сказала, когда уликами делилась, что их нашел Аполлонов? POS hld",
		"character_temich SHOW : Да. И я сейчас не удивлюсь, если Палтос выйдет... POS def",
		...
		"И что там еще.",
		"Тебе ли не знать, Ирод Окаянный, что прокуроры требуют от каждого свида.",
		"character_wit SHOW  Тебя не спрашивали. POS wit",
		"character_temich SHOW : *вздох* как скажешь. POS def",
		"(В следующий раз, когда он что-то спросит у неё, я включу секундомер) B",
		"(Посмотрим, на сколько его хватит...)",
		"character_wit SHOW  Ладно, что касается преступления... W POS wit",
		"character_sonya SHOW : ... POS pro",
		"Анкета. Y",
		"character_wit SHOW  А, что? W POS wit",
		"character_temich SHOW : *вздох* POS def",
		"(Это надолго...) B",
		...
		"character_wit SHOW  Это реально так важно? POS wit",
		"character_temich SHOW : Внатуре, ну легче уже этот шаг пропустить. POS def",
		...
		"character_wit SHOW  Так я следователь, или свидетель? POS wit",
		"character_temich SHOW : ........ POS def",
		"OUT",
		"",
	]
	Ev = [
