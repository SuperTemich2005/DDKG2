...
func _ready():
	Dialogue = [
		"",
		"--- Что я видел --- R",
		"Радомир: Я сидел в парке с другом. G I9",
		"Радомир: Мы там сидели и ничего не делали. G I25",
		"Радомир: Внезапно, я увидел, как на одну девочку зверски бьёт и режет другая G I33",
		"Радомир: Страшное зрелище G I58",
		"Радомир: Мимо нас проходило несколько человек, но вряд ли они это видели. G I83",
		...
		"SPLIT Эффективно Круто 21 21",
		"(...Какая разница, кстати?)",
		"Тёмыч: Ладно, свидетель, продолжайте. W",
		"",
		"JUMP 2",
	...
	Anims = [
		...
		"character_wit2 default START examination-allegro Радомир: Я сидел в парке с другом. W POS wit",
