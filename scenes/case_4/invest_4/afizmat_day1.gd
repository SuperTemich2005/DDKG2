...
#	BoxColor = Color(0.5,1,0.5,1)
	Dialogue = [ # диалоги. 
		...
		"Егорыч: Тьоха, ну че ты так категорично?|W|character_egorich thinks",
		"Тёмыч: В смысле?",
		...
		"Там есть и вторая",
		"За ней идёт третья",
		"Четвёртая, пятая, десятая, двухсотая.|W|character_egorich suspects",
		...
		"Егорыч: Но как же Соня? Вера Юрьевна сказала, что она готовилась стать прокурором и встать против тебя.|W|character_egorich thinks",
		"Тёмыч: Она просто сказала, что Соня станет прокурором в школьном суде. Не более.",
		...
		"Тёмыч: Ну, благоразумных людей достаточно, чтобы спокойно жить",
